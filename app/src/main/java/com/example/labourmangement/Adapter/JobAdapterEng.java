...
public class JobAdapterEng extends RecyclerView.Adapter<JobAdapterEng.ViewHolder>{
    ...
    public JobAdapterEng(Context context, List JobModel) {
        this.context = context;
        this.jobModels = JobModel;
    }

    @Override
    public JobAdapterEng.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.single_job_list, parent, false);
        JobAdapterEng.ViewHolder viewHolder = new JobAdapterEng.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(JobAdapterEng.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, EngJobDetails.class);
