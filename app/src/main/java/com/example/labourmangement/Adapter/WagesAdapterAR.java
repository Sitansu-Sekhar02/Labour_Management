...
public class WagesAdapterAR extends RecyclerView.Adapter<WagesAdapterAR.ViewHolder> {
    ...
    public WagesAdapterAR(Context context, List jobwagesmodel) {
        this.context = context;
        this.jobwagesmodel = jobwagesmodel;
    }
    @Override
    public WagesAdapterAR.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.job_wages_list, parent, false);
        WagesAdapterAR.ViewHolder viewHolder = new WagesAdapterAR.ViewHolder(v);
        return viewHolder;
    }
    @Override
    public void onBindViewHolder(WagesAdapterAR.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, WagesRequestAR.class);
