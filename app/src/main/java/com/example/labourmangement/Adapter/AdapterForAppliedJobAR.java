...
import com.example.labourmangement.Architect.JobAppliedDetailsEng;
...
public class AdapterForAppliedJobAR extends RecyclerView.Adapter<AdapterForAppliedJobAR.ViewHolder>{
    ...
    public AdapterForAppliedJobAR(Context context, List appliedjob) {
        this.context = context;
        this.appliedjob = appliedjob;
    }

    @Override
    public AdapterForAppliedJobAR.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View v = LayoutInflater.from(parent.getContext()).inflate(R.layout.applied_job_list, parent, false);
        AdapterForAppliedJobAR.ViewHolder viewHolder = new AdapterForAppliedJobAR.ViewHolder(v);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(AdapterForAppliedJobAR.ViewHolder holder, int position) {
        ...
        holder.itemView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Intent intent = new Intent(context, JobAppliedDetailsEng.class);
